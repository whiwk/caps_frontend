          ...
          <TextContent style={{ marginRight:'200px', marginLeft:'8px'}}>
            ...
            <TextList component={TextListVariants.ol}>
              <TextListItem>Access and Mobility Management Function (AMF)
                <TextList>
                  <TextListItem style={{ textAlign: 'justify' }}>Function: Manages user equipment (UE) access and mobility.</TextListItem>
                  <TextListItem style={{ textAlign: 'justify' }}>Role: Ensures efficient handling of user registrations, authentication, and mobility management, providing continuous connectivity as users move across different network areas.</TextListItem>
                </TextList>
              </TextListItem>
              <TextListItem>Session Management Function (SMF)
                <TextList>
                  <TextListItem style={{ textAlign: 'justify' }}>Function: Handles session management and IP address allocation.</TextListItem>
                  <TextListItem style={{ textAlign: 'justify' }}>Role: Manages the establishment, modification, and release of user sessions, ensuring optimal use of network resources and consistent IP address allocation for seamless data services.</TextListItem>
                </TextList>
              </TextListItem>
              <TextListItem>User Plane Function (UPF)
                <TextList>
                  <TextListItem style={{ textAlign: 'justify' }}>Function: Manages user plane traffic and routing.</TextListItem>
                  <TextListItem style={{ textAlign: 'justify' }}>Role: Directs the data traffic between user devices and external data networks, optimizing the data flow and minimizing latency for an enhanced user experience.</TextListItem>
                </TextList>
              </TextListItem>
              <TextListItem>Network Repository Function (NRF)
                <TextList>
                  <TextListItem style={{ textAlign: 'justify' }}>Function: Maintains a repository of network functions and their profiles.</TextListItem>
                  <TextListItem style={{ textAlign: 'justify' }}>Role: Acts as a centralized registry for all network functions, facilitating efficient discovery and communication between different components within the 5G Core Network.</TextListItem>
                </TextList>
              </TextListItem>
              <TextListItem>Policy Control Function (PCF)
                <TextList>
                  <TextListItem style={{ textAlign: 'justify' }}>Function: Enforces network policies.</TextListItem>
                  <TextListItem style={{ textAlign: 'justify' }}>Role: Implements dynamic policy rules to manage network behavior, ensuring quality of service (QoS), resource allocation, and compliance with regulatory requirements.</TextListItem>
                </TextList>
              </TextListItem>
              <TextListItem>Unified Data Management (UDM)
                <TextList>
                  <TextListItem style={{ textAlign: 'justify' }}>Function: Manages user data and profiles.</TextListItem>
                  <TextListItem style={{ textAlign: 'justify' }}>Role: Stores and handles subscriber information, authentication credentials, and user profiles, enabling personalized services and secure access to the network.</TextListItem>
                </TextList>
              </TextListItem>
            </TextList>
            ...
            <TextList component={TextListVariants.ol}>
              <TextListItem>Central Unit (CU)
                <TextList>
                  <TextListItem style={{ textAlign: 'justify' }}>Function: Controls the radio network, manages signaling, and processes data.</TextListItem>
                  <TextListItem style={{ textAlign: 'justify' }}>Role: The CU acts as the brain of the Open RAN architecture, handling non-real-time
              ...
              <TextListItem>Distributed Unit (DU)
                <TextList>
                  <TextListItem style={{ textAlign: 'justify' }}>Function: Handles real-time processing and radio signal management.</TextListItem>
                  <TextListItem style={{ textAlign: 'justify' }}>Role: Positioned closer to the end-user, the DU is responsible for real-time operations, 
              ...
              <TextListItem>Radio Unit (RU)
                <TextList>
                  <TextListItem style={{ textAlign: 'justify' }}>Function: Converts digital signals to radio waves and vice versa, interfacing with the antennas.</TextListItem>
                  <TextListItem style={{ textAlign: 'justify' }}>Role: The RU operates at the network's edge, interfacing directly with the antennas to transmit 
            ...
            <TextList component={TextListVariants.ol}>
              <TextListItem style={{ textAlign: 'justify' }}>Interoperability: By adhering to open standards, Open RAN allows equipment from different vendors 
                to work together seamlessly, reducing reliance on proprietary solutions and fostering a competitive market.
              </TextListItem>
              <TextListItem style={{ textAlign: 'justify' }}>Flexibility: Open interfaces enable operators to mix and match components from various suppliers, 
                optimizing their networks to meet specific needs and deploying new services more quickly.
              </TextListItem>
              <TextListItem style={{ textAlign: 'justify' }}>Cost Efficiency: By breaking the vendor lock-in, Open RAN can significantly lower capital and 
                operational expenditures, allowing operators to allocate resources more effectively.
              </TextListItem>
              <TextListItem style={{ textAlign: 'justify' }}>Innovation: Open RAN encourages innovation by creating a more dynamic ecosystem where new 
